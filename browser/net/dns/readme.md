...
```cpp
 	net.dll!net::TransportConnectJob::TransportConnectJob 行 134
 	net.dll!std::__Cr::make_unique<...> 行 756
>	net.dll!net::HttpProxyConnectJob::DoTransportConnect 行 499
 	net.dll!net::HttpProxyConnectJob::DoLoop 行 429
 	net.dll!net::HttpProxyConnectJob::ConnectInternal 行 389
 	net.dll!net::ConnectJob::Connect 行 130
 	net.dll!net::SSLConnectJob::DoTunnelConnect 行 311
 	net.dll!net::SSLConnectJob::DoLoop 行 216
 	net.dll!net::SSLConnectJob::ConnectInternal 行 544
 	net.dll!net::ConnectJob::Connect 行 130
 	net.dll!net::TransportClientSocketPool::RequestSocketInternal 行 463
 	net.dll!net::TransportClientSocketPool::RequestSockets 行 348
 	net.dll!net::`anonymous namespace'::InitSocketPoolHelper 行 126
```
...
>	net.dll!net::HostCache::LookupInternal 行 847
 	net.dll!net::HostCache::LookupInternalIgnoringFields 行 832
 	net.dll!net::HostCache::Lookup 行 745
 	net.dll!net::HostResolverManager::MaybeServeFromCache 行 1052
 	net.dll!net::HostResolverManager::ResolveLocally 行 895
 	net.dll!net::HostResolverManager::RequestImpl::DoResolveLocally 行 331
>	net.dll!net::HostResolverManager::RequestImpl::DoLoop 行 252
 	net.dll!net::HostResolverManager::RequestImpl::Start 行 96
 	services_network_network_service.dll!network::ResolveHostRequest::Start 行 90
...
>	net.dll!net::HostResolverManager::ServeFromHosts 行 1113
 	net.dll!net::HostResolverManager::ResolveLocally 行 921
 	net.dll!net::HostResolverManager::ServiceEndpointRequestImpl::DoResolveLocally 行 349
 	net.dll!net::HostResolverManager::ServiceEndpointRequestImpl::DoLoop 行 280
 	net.dll!net::HostResolverManager::ServiceEndpointRequestImpl::Start 行 95
...
>	net.dll!net::UDPSocketWin::SendToOrWrite 行 465
 	net.dll!net::UDPSocketWin::Write 行 443
 	net.dll!net::UDPClientSocket::Write 行 198
 	services_network_network_service.dll!network::BrokeredUdpClientSocket::Write 行 236
 	net.dll!net::`anonymous namespace'::DnsUDPAttempt::DoSendQuery 行 341
 	net.dll!net::`anonymous namespace'::DnsUDPAttempt::DoLoop 行 301
 	net.dll!net::`anonymous namespace'::DnsUDPAttempt::Start 行 258
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::MakeUdpAttempt 行 1466
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::MakeClassicDnsAttempt 行 1424
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::MakeAttempt 行 1400
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::StartQuery 行 1596
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::Start 行 1272
 	net.dll!net::HostResolverDnsTask::CreateAndStartTransaction 行 456
 	net.dll!net::HostResolverDnsTask::StartNextTransaction 行 312
 	net.dll!net::HostResolverManager::Job::StartDnsTask 行 722
 	net.dll!net::HostResolverManager::Job::RunNextTask 行 457
 	net.dll!net::HostResolverManager::Job::Start 行 611
 	net.dll!net::PrioritizedDispatcher::Add 行 35
 	net.dll!net::HostResolverManager::Job::Schedule 行 211
 	net.dll!net::HostResolverManager::Job::RunNextTask 行 431
 	net.dll!net::HostResolverManager::CreateAndStartJobForServiceEndpointRequest 行 996
 	net.dll!net::HostResolverManager::ServiceEndpointRequestImpl::DoStartJob 行 421
 	net.dll!net::HostResolverManager::ServiceEndpointRequestImpl::DoLoop 行 283
 	net.dll!net::HostResolverManager::ServiceEndpointRequestImpl::Start 行 95
...
>	net.dll!net::ClassicDnsServerIterator::GetNextAttemptIndex 行 132
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::MakeClassicDnsAttempt 行 1416
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::MakeAttempt 行 1400
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::ProcessAttemptResult 行 1684
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::OnFallbackPeriodExpired 行 1770
...
>	net.dll!net::`anonymous namespace'::ExtractResponseRecords 行 218
 	net.dll!net::`anonymous namespace'::ExtractAddressResults 行 325
 	net.dll!net::DnsResponseResultExtractor::ExtractDnsResults 行 652
 	net.dll!net::HostResolverDnsTask::OnDnsTransactionComplete 行 561
  // ...
 	net.dll!net::`anonymous namespace'::DnsTransactionImpl::DoCallback 行 1381
	net.dll!net::`anonymous namespace'::DnsTransactionImpl::OnAttemptComplete 行 1615
  // ...
 	net.dll!net::`anonymous namespace'::DnsUDPAttempt::OnIOComplete 行 396
...
>	net.dll!net::AddrInfoGetter::getaddrinfo 行 201
 	net.dll!net::AddressInfo::Get 行 64
 	net.dll!net::SystemHostResolverCall 行 612
 	net.dll!net::`anonymous namespace'::ResolveOnWorkerThread 行 117

  // ...

 	net.dll!net::HostResolverSystemTask::StartLookupAttempt 行 387
 	net.dll!net::HostResolverSystemTask::Start 行 326
 	net.dll!net::HostResolverManager::Job::StartSystemTask 行 637
>	net.dll!net::HostResolverManager::Job::RunNextTask 行 454    // case TaskType::SYSTEM:
 	net.dll!net::HostResolverManager::Job::OnDnsTaskFailure 行 774
 	net.dll!net::HostResolverManager::Job::OnDnsTaskComplete 行 799
 	net.dll!net::HostResolverDnsTask::OnSuccess 行 1040
 	net.dll!net::HostResolverDnsTask::OnTransactionsFinished 行 917
 	net.dll!net::HostResolverDnsTask::HandleTransactionResults 行 880
 	net.dll!net::HostResolverDnsTask::SortTransactionAndHandleResults 行 754
 	net.dll!net::HostResolverDnsTask::OnDnsTransactionComplete 行 653
