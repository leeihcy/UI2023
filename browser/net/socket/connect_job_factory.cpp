...
std::unique_ptr<ConnectJob> ConnectJobFactory::CreateConnectJob(const ConnectJobFactory::Endpoint& endpoint) 
{
  // TODO: 按JOB类型进行创建。
  ...
  return m_transport_connect_job_factory->Create(transport_job_params);
}
