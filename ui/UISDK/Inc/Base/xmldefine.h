...
#define XML_RENDER_LIST_STATEMAPINDEX     _T("render.statemap")    // 设置控件绘制状态对应的图片项，例如0:0,1:0,2:0,3:0,4:1 表示有两个图片项，但selection用第二张图片，其它用第一张图片
...
#define XML_RENDER_IMAGE_DRAWTYPE_BITBLT_LEFTVCENTER  _T("bitbltleftvcenter") // 左中对齐
...
#define  XML_EDIT_MAX_LENGTH_BYTELIMIT        _T("bytelimit")        // 按字节限制长度，汉字算两个
