...
//
CSSParserToken CSSTokenizer::NextToken(NextTokenConfig config) {
  do {
    char16_t c = Consume();
    switch (c) {
    case 0:
...
CSSParserTokenStream::CSSParserTokenStream(const char16_t* buffer, size_t size) {
