#ifndef _HTML_CSS_ROBIN_HOOD_MAP_H_
#define _HTML_CSS_ROBIN_HOOD_MAP_H_
...
struct RobinHoodMap {
 ...
 public:
  ...
  inline Bucket* Insert(const Key& key);
 ...
 private:
  Bucket* EndBucket() {
    return buckets_.get() ? (buckets_.get() + num_buckets_ +
  ...
  // Grow() immediately.
  inline Bucket* InsertInternal(Bucket to_insert);
