...
public:
  ...
  void SetBlock(bool b) { m_bBlock = b; }
  bool IsBlock() { return m_bBlock; }
  void SetDuration(float ms) { m_fDuration = ms; }
  float GetDuration() { return m_fDuration; }
  void
  SetFinishCallback(std::function<void(const LayerAnimateFinishParam &)> func) {
  ...
  void SetEaseType(uia::EaseType e) { m_eEaseType = e; }

  uia::EaseType GetEaseType() { return m_eEaseType; }
