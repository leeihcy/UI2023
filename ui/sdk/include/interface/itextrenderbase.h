...
struct UIAPI ITextRenderBase : public IMessage
{
	...
	void  DrawState(IRenderTarget* pRenderTarget, const RECT* prc, int nState, const wchar_t* szText, int nDrawTextFlag=-1);
	void  Init();
...
struct // __declspec(uuid("230E9C5F-7F13-4307-85E7-088AB6F44C9D"))
...
struct // __declspec(uuid("43851BC4-E18A-457E-AFCC-C4D0C638F376"))
...
struct // __declspec(uuid("69A57DAA-1E49-4FCD-A334-03FA3A5FF420"))
...
struct // __declspec(uuid("9646EBCD-6F6C-4748-9603-847C57CF29D7"))
...
struct // __declspec(uuid("FE20349B-8D97-4C86-82A4-4A27C8F152C1"))
