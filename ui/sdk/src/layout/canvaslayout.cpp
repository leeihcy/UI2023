...
void  CanvasLayoutParam::Serialize(SERIALIZEDATA* pData)
{
    ...
    s.AddLong(
            XML_WIDTH,
            Slot(&CanvasLayoutParam::LoadConfigWidth, this), 
    ...
    s.AddLong(
            XML_HEIGHT,
            Slot(&CanvasLayoutParam::LoadConfigHeight, this), 
    ...
    s.AddLong(
            XML_LAYOUT_ITEM_TOP, 
            Slot(&CanvasLayoutParam::LoadConfigTop, this), 
...
// 		else if (0 == wcscmp(szFlag, XML_LAYOUT_ALIGN_FORCE_DESIREDSIZE))
