...
const char *Resource::GetName() { return m_strSkinResName.c_str(); }
...
bool Resource::Load() {
  ...
  if (parse.Parse(m_pDataSource, XML_RESOURCE_XML)) {
...
Resource *Resource::GetParentSkinRes() { return m_pParentSkinRes; }
...
I18nRes &Resource::GetI18nRes() { return m_mgrI18n.GetI18nRes(); }
} // namespace ui