...
Window* Object::GetWindowObject()
{
    ...
    IWindow* pWindow = (IWindow*)pParent->
			GetIObject()->QueryInterface(__guid(IWindow));
    if (pWindow)
...
//
// 
// bool Object::OnSetCursor(HWND hWnd, unsigned int nHitTest, unsigned int message)
// {
...
// void Object::ModifyStyleEx(unsigned int nStyleAdd, unsigned int nStyleRemove, bool bNotify)
// {
//     STYLESTRUCT s;
...
void  Object::load_textrender(const wchar_t* szName, ITextRenderBase*& pTextRender)
{
