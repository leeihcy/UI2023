...
SizeAttribute::~SizeAttribute() { SAFE_DELETE(m_pISizeAttribute); }

void SizeAttribute::SetBindValue(void *p) { m_pBindValue = (Size *)p; }

// void  SizeAttribute::SetBindFuction(void* _this, void* _setter, void*
// _getter)
// {
//     this->_this = _this;
...
void SizeAttribute::Set(const char *szValue) {
  Size s = {0};
...
void SizeAttribute::Reset() { set(&m_sizeDefault); }
...
void SizeAttribute::Editor(SerializeParam *pData, AttributeEditorProxy *p,
