...
const wchar_t*  BoolAttribute::Get()
{
    bool b = GetBool();

	wchar_t* szText = GetTempBuffer(64);
    wcscpy(szText, b ? XML_BOOL_VALUE_1 : XML_BOOL_VALUE_0);
    
    return szText;
}

void  BoolAttribute::Set(const wchar_t* szValue)
{
    bool b = false;
...
void  BoolAttribute::Editor(SerializeParam* pData, AttributeEditorProxy* p, EditorAttributeFlag e)
{
